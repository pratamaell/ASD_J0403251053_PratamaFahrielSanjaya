...
# Menggunakan Linked List (Tanpa Python List)
#=========================================================
...
# Kelas QueueBengkel: Implementasi Queue menggunakan Linked List
# Menggunakan 2 pointer: front (depan) dan rear (belakang)
class QueueBengkel:
    def __init__(self):
    ...
    # Method is_empty: Mengecek apakah queue kosong
    def is_empty(self):
        return self.front is None

    # Method enqueue: Menambahkan pelanggan ke akhir antrian
    ...
    def tampilkan(self):
        ...
        print("\n=== Daftar Antrian ===")
        print("-" * 50)
        print(f"{'No Antri':<12} {'Nama':<20} {'Servis':<15}")
        print("-" * 50)
        
        current = self.front  
        while current is not None:  
            print(f"{current.no:<12} {current.nama:<20} {current.servis:<15}")
